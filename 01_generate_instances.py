...
if __name__ == '__main__':
    ...
    if args.problem == 'setcover':
        ...
        n = 300
        # nrows = 2000
        lp_dir = f'data/instances/setcover/hxl_transfer_{nrows}r_{ncols}c_{dens}d'
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
        nrowss.extend([nrows] * n)
        ...
        print(f"{n} instances in {lp_dir}")
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+2000}.lp') for i in range(n)])
        ...
        # train instances
        n = 5000
        lp_dir = f'data/instances/facilities/3000_train_{number_of_customers}_{number_of_facilities}_{ratio}'
        print(f"{n} instances in {lp_dir}")
        input()
        os.makedirs(lp_dir)
        filenames.extend([os.path.join(lp_dir, f'instance_{i+1}.lp') for i in range(n)])
